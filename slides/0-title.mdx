...
## YahooMap!の積極利用を始めた背景

### Google Mapsの使用制限

Google Maps がクレジットカード情報の登録が必須になり、無料での利用が 28,000pv/月までと仕様が変更になりました。
...
地図に複数のピンを立てることについては、どのサービスでも可能ですが Google では公式に Marker Clustering という機能が提供されています

![](https://www.appleple.com/archives/002/201901/981b5c542715e6ce99236e718ac72710.png)
